...
const QuizCard = ({ id, title, description, subject, difficulty, questionCount }: QuizCardProps) => {
  return (
    <Card className="bg-white dark:bg-gray-800 shadow-md rounded-lg">
      <CardHeader>
        ...
        <div className="flex flex-wrap gap-2 mt-2 text-sm text-gray-600 dark:text-gray-400">
          ...
          <span className="flex items-center"><Hash className="h-4 w-4 mr-1" /> {questionCount} Questions</span>
        </div>
      </CardHeader>
